...
public class InputView {
    private final static String TEXT_QUESTION_CAR_NAME_JOIN_RACE = "경주할 자동차 이름을 입력하세요(이름은 쉼표(,)를 기준으로 구분).";
    private final static String TEXT_QUESTION_RACING_TIME = "시도할 회수는 몇 회 인가요?";
