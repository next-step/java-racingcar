...
public class ValidationCheck {
    ...
    public static void checkInputPlayerName(String playerNames) {
    ...
    public static void checkInputSplitName(String[] eachName) {
    ...
    public static void checkInputTryCount(int tryCount) {
    ...
    public static void checkCarNumber(int carNumber, int carPositionSize) {
        if (carNumber != carPositionSize) {
            throw new IllegalArgumentException("입력한 값과 출전하는 차량의 수가 일치하지 않습니다.");
        }
    }

    public static void checkRandomValue(int randomNum) {
