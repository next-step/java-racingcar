...
public final class MathContext {
    ...
    // 사용자의 입력 값 -> Operator만 필터링 -> Operator로 파싱 -> LinkedList 타입으로 반환
    private LinkedList<Operator> setOperations(String[] userInput) {
    ...
    private LinkedList<Integer> setNumbers(String[] userInput) {
        return Arrays.stream(userInput)
