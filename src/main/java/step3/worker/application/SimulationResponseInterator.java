package step3.worker.application;

import common.util.Message;
import step3.worker.domain.*;
import step3.worker.domain.strategy.RandomMovableStrategy;

import java.util.List;
import java.util.Objects;

import static common.util.Preconditions.checkArgument;
import static step3.worker.application.SimulationResponseInterator.ErrorMessage.NOT_BE_NULL;
