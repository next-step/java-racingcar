...
public class ResultView {
    private static String PRINT_CAR_COUNT = "자동차 대수는 몇 대 인가요?";
    private static String PRINT_TRY_COUNT = "시도할 회수는 몇 회 인가요?";
    private static String PRINT_RESULT_MESSAGE = "실행 결과";
    private static String PRINT_GO_DISTANCE="-";
