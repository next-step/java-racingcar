...
public class InputView {
	...
	private static final String MESSAGE_WINNER_RESULT = "이(가) 최종 우승했습니다.";
	...
	public static void getWinnerResult(String winnerList) {
		System.out.println(winnerList + MESSAGE_WINNER_RESULT);
	}

	public static void getStageResult(String delimiter, Racingcar racingcar) {
		System.out.println(racingcar.getCarName() + delimiter + racingcar.getCarPosition());
	}
