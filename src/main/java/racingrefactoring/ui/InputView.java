...
import racingrefactoring.domain.CarValidator;

import java.util.Scanner;

public class InputView {

	private static final String WRONG_NAME_LENGTH_MESSAGE = "자동차 이름은 5자를 초과할 수 없습니다. 다시 입력 해주세요.";
	...
	private boolean isWrongNames(String[] names) {
		if (CarValidator.hasInvalidName(names)) {
