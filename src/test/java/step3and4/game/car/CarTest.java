...
class CarTest {
    ...
    void a() {
        ...
        final Car sut = new Car.Factory(number, new Position(0), "").car();

        assertThat(sut.movedCar()).isEqualTo(new Car.Factory(number, new Position(1), "").car());
    }
    ...
    void b() {
        ...
        assertThat(sut.movedCar()).isEqualTo(new Car.Factory(number, new Position(0), "").car());
    }
