...
class CarNameUtilTest {

    @DisplayName("참가자 이름 입력 테스트")
    @Test
    void participantsSplitTest() {
        String participants = "name1,name2,name3";
        assertThat(CarNameUtil.participantsSplit(participants).length).isEqualTo(3);
    }
    ...
    void participantsSplitExceptionTest() {
        String participants = "";
        assertThatThrownBy(() -> CarNameUtil.participantsSplit(participants))
