...
import step4.racing.RacingGame;
...
public class RacingGameTest {
    ...
    void 자동차_이름은_쉼표를_기준으로_구분한다() {
        ...
        assertThat(racingGame.carNames().length).isEqualTo(3);
        assertThat(racingGame.carNames())
            .containsExactly("pobi", "crong", "honux");
    }

    @Test
    void 우승자는_한명_이상일수_있다() {
        RacingGame racingGame = new RacingGame("pobi,crong,honux", 0);
