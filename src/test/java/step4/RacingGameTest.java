...
//    private MoveStrategy defaultCondition;
...
//    @BeforeEach
//    void setUp() {
//        this.defaultCondition = RandomMoveStrategy.randomCondition();
...
//        MoveStrategy randomMovement = RandomMoveStrategy.randomCondition();
//        Car car = new Car(defaultCarName, defaultCondition);
//
