...
public class StringTest {
     ...
     */
    @Test
    @DisplayName("\"1,2\"를 split 했을 때 1과 2로 잘 분리되는지 + \"1\"을 ,로 split 했을 때 1만을 포함하는 배열이 반환되는지 확인")
    void stringTestNo1() {
     ...
     */
    @Test
    @DisplayName("charAt() 메소드 사용 시 StringIndexOutOfBoundsException이 발생하는 것을 확인")
    void stringTestNo3() {
