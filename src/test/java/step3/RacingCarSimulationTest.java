...
class RacingCarSimulationTest {
    ...
    @Test
    void start() {
        final NextStepRacingCarSimulation simulation = new NextStepRacingCarSimulation(new InputView());
        final ResultView resultView = simulation.start();
    ...
    public static class NextStepRacingCarSimulation {
        ...
        public ResultView start() {
            ...
            return new ResultView(simulateResult);
        }
    }
