...
//
//        RacingRecords racingRecords = this.racingRecords.get(0);
//
//        String carName1 = racingRecords.getRacingRecordsInCar(0).getName();
//        String carName2 = racingRecords.getRacingRecordsInCar(1).getName();
//        String carName3 = racingRecords.getRacingRecordsInCar(2).getName();
//
//        assertAll(
