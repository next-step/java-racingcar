...
class CarsTest {
    ...
    @Test
    void carsSizeTest() {
        Car car1 = new Car(new CarName(CarName.checkCarName("t1").getName()), new CarPosition(0));
        Car car2 = new Car(new CarName(CarName.checkCarName("t2").getName()), new CarPosition(0));
    ...
    @Test
    void findWinner() {
        Car car1 = new Car(new CarName(CarName.checkCarName("t1").getName()), new CarPosition(2));
        Car car2 = new Car(new CarName(CarName.checkCarName("t2").getName()), new CarPosition(5));
