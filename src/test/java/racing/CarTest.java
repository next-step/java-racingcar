...
class CarTest {
    ...
    void movePositionTest() {
        testCar.move(RandomMovingStrategy.isMove(4));
    ...
    void stopPositionTest() {
        testCar.move(RandomMovingStrategy.isMove(3));
    ...
    void nameAndPositionTest() {
        testCar.move(new AlwaysMoveMovingStrategy());
    ...
    void deepCopyTest() {
        ...
        deepCopyCar.move(new AlwaysMoveMovingStrategy());
