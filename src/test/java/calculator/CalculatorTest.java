...
public class CalculatorTest {
    ...
    void testAllOperator() {
        double actual = calculator.calculate("10 / 5 + 7 - 2 * 3");
        assertThat(actual).isEqualTo(21);
    }

    @ParameterizedTest
    @NullAndEmptySource
    @DisplayName("입력 값이 null이거나 빈 공백 문자일 경우 IllegalArgumentException")
