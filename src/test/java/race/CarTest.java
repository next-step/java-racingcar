...
class CarTest {
    ...
    void getDistanceByRound(int round, int expected) {
        Car car = Car.of(DEFAULT_TRY_COUNT, DEFAULT_NAMES);
        car.move();
        assertThat(car.getDistanceByRound(round)).isGreaterThanOrEqualTo(expected);
    }
    ...
    void move() {
        Car car = Car.of(DEFAULT_TRY_COUNT, DEFAULT_NAMES);
        car.move();
        assertThat(car.getDistance().size()).isEqualTo(DEFAULT_TRY_COUNT);
    }
