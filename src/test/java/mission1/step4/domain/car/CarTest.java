...
class CarTest {
    ...
    public void createCarByIllegalName() {
        assertThrows(IllegalArgumentException.class, () -> Car.create("testtest", new MoveByRandomValue()));
    }
    ...
    public void carProgressCheck(int randomValue1, int randomValue2, int randomValue3, int expectedProgress) {
        Car car = Car.create("test", new MoveByRandomValue());
        car.move(randomValue1);
        car.move(randomValue2);
        car.move(randomValue3);
