...
public class CalculatorTest {
    ...
    @DisplayName("문자열 다항식에 대한 덧셈 기능 테스트")
    @ParameterizedTest
    ...
    @DisplayName("문자열 다항식에 대한 뺄셈 기능 테스트")
    @ParameterizedTest
    ...
    @DisplayName("문자열 다항식에 대한 곱셈 기능 테스트")
    @ParameterizedTest
    ...
    @DisplayName("문자열 다항식에 대한 나눗셈 기능 테스트")
    @ParameterizedTest
    ...
    @DisplayName("이항 이상의 문자열 다항식에 대한 계산 테스트")
    @ParameterizedTest
