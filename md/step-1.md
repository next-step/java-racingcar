...
### 힌트
- [x] 배열로 반환하는 값의 경우 assertj 의 contains()를 활용해 반환 값이 맞는지 검증한다.
- [x] 배열로 반환하는 값의 경우 assertj 의 containsExactly()를 활용해 반환 값이 맞는지 검증한다.
...
- [x] JUnit 의 @DisplayName 을 활용해 테스트 메소드의 의도를 드러낸다.
