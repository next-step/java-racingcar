...
- [ ] 자동차 전진 기능
  - [ ] 0~9 사이의 랜덤 값을 생성한다
  - [ ] 랜덤 값이 4 이상이면 전진, 미만이면 정지한다
  - [ ] 전진할 때마다 위치 값이 1씩 증가한다
### 입력
- [ ] 자동차 대수 입력 
  - [ ] 양수를 입력하면 해당 값 출력
  - [ ] 숫자 형식이 아니면 "자동차 대수는 숫자이어야 합니다. 다시 입력해주세요" 출력
  - [ ] 양수가 아니면 "자동차 대수는 1이상이어야 합니다. 다시 입력해주세요" 출력
- [ ] 시도 횟수 입력
  - [ ] 양수를 입력하면 해당 값 출력
  - [ ] 숫자 형식이 아니면 "시도 횟수는 숫자이어야 합니다. 다시 입력해주세요" 출력
  - [ ] 양수가 아니면 "시도 횟수는 숫자이어야 합니다. 다시 입력해주세요" 출력
- [ ] 입력 완료 후 빈 줄 출력
### 출력
- [ ] 실행 결과 출력
  - [ ] "실행 결과" 문구 출력
- [ ] 각 라운드마다 모든 자동차 상태 출력
  - [ ] 자동차별로 한 줄씩 출력
  - [ ] 위치만큼 "-" 출력
  - [ ] 라운드 종료 후 빈 줄 출력
  - [ ] 마지막 라운드는 빈줄 없음
