...
- [ ] 자동차 경주 우승자 출력 기능 구현
    ...
    - [ ] RacingGame 기능 변경
        - [ ] String 콜렉션 형태의 참가자 이름을 입력받아서 차량을 생산할 수 있도록 기능 변경
    - [ ] CarFactory 기능 변경
        - [ ] 참가자 목록을 입력받아서 경기에 참가할 차량을 생산하도록 기능 변경
    - [ ] Car 기능 변경
        - [ ] 움직인 거리 외 참가자 이름을 관리할 수 있도록 기능 변경
    - [ ] Round 기능 삭제
        - [ ] 결과 출력 메서드 삭제
    - [ ] RacingGame 기능 변경
        - [ ] result 프로퍼티의 속성의 타입을 List<Round> 타입으로 변경
    - [ ] OutputView 기능 변경
