...
- [x] 사용자는 자동차의 이름을 쉼표로 구분하여 입력한다.
- [x] 각 자동차에 이름을 부여할 수 있다.
- [x] 자동차의 이름이 5자를 초과하면, 에러가 발생한다.
- [x] 자동차 경주 게임을 완료하면 우승자가 반환된다.
- [x] 자동차 경주 게임을 한번 실행했을 때, 위치를 반환한다.
- [x] 자동차 경주 우승자의 위치를 출력한다.
...
### 코멘트
- [x] Car객체의 name이 유니크하지 않기 때문에 동일한 name에 동일한 position인 인스턴스가 여러개가 있을수 있습니다. 이런 케이스를 고민해보셔야 합니다.
- [x] 동시 우승자도 한번 테스트를 해보시면 어떨까요?
...
### 코멘트
- [x] CarPosition.isSame()은 equals로 나타내볼 수 있을거 같습니다. 혹은 comparable을 구현해보셔도 좋을거 같아요.